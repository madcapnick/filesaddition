...
Description: Originally Developed by Hai Bui (https://www.fldtrace.com/) and adapted by Nick Mabee for use with Sliced Invoices Client Area Plugin. Shows private files within the client area.
Author: Nick Mabee - madcap creative
...
function upf_list_user_files() {
	...
	<div class="table-responsive">
            <table id="table-quotes" class="table table-sm table-bordered table-striped display" cellspacing="0" width="100%">
					<thead>
                        <tr>
                            <th class="title"><strong>Filename</strong></th>
                            <th class="title"><strong>View file</strong></th>
                            <th class="title"><strong>Download File</strong></th>
						</tr>
					</thead>
					<tbody>
	<?php
		...
		while ( $the_query->have_posts() ) : $the_query->the_post(); 
			...
			?>
						<tr class="row_<?php echo esc_attr( $class ); ?> sliced-item">
                            <td class="title" width="33%"><span class="report-name"><?php the_title();?></span></td>
                            <td class="title" width="33%"><a href="?upf=vw&id=<?php echo get_the_ID();?>" class="view-print" target="_blank"><?php _e('View and Print', 'user-private-files');?></a></td>
                            <td class="title" width="33%"><a href="?upf=dl&id=<?php echo get_the_ID();?>" class="download" target="_blank"><?php _e('Download', 'user-private-files');?></a></td>
                        </tr>
